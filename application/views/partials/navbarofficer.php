    ...
    <div class="w-full flex items-center justify-end ms-auto sm:justify-between sm:gap-x-3 sm:order-3">
      ...
      <div class="flex flex-row items-center justify-end gap-2">
        ...
        */
        ...
        <button id="pwa-install-btn" type="button" class="hidden items-center justify-center rounded-full border border-cyan-200 bg-cyan-50 p-2 text-cyan-700 hover:bg-cyan-100 dark:border-cyan-700 dark:bg-cyan-800/30 dark:text-cyan-200 dark:hover:bg-cyan-700/40" aria-label="Install app" title="Install app">
